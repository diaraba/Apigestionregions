...
import com.apigestionregions.Apigestionregions.repository.RegionsRepository;
...
public class RegionsServiceImpl implements RegionsService{
    ...
    @Override
    public Pays getNomregions(Regions regions) {
        return regionsRepository.findByNomregions(regions.getNomregions());
    }
}
